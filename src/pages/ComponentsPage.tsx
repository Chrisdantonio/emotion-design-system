    ...
    <div className="app">
      ...
      <aside className="sidebar">
        <div className="sidebar__brand">
          <img src="/emotion-design-system/logo.png" alt="Emotion Design System logo" className="sidebar__logo-img" />
      ...
      <main className="main">
        ...
        <section id="molecules" className="ds-section">
          ...
          <div className="component-entry">
            <div className="component-entry__header">
              <span className="layer-badge">Molecule</span>
              <h3 className="component-entry__name">ImageCard</h3>
              <p className="component-entry__desc">Media card with a constrained aspect-ratio image, optional caption credit, title, and description. Wraps as a link when href is provided.</p>
            </div>
            <div className="component-entry__demo">
              <div className="demo-area demo-area--image-cards">
                <ImageCard
                  src="https://images.unsplash.com/photo-1777175513145-df96434822a9?fm=jpg&q=60&w=800&auto=format&fit=crop"
                  alt="Field of blurred yellow and white tulips in green grass"
                  title="Vertical"
                  layout="vertical"
                  credit="Squids Z"
                />
